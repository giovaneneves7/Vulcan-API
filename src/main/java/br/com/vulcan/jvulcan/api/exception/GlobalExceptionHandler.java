...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ResponseStatus(HttpStatus.INTERNAL_SERVER_ERROR)
    public ResponseEntity<Object> handleMessageNotSentException(
            MessageNotSentException messageNotSentException,
            WebRequest request) {
        log.error("Failed to find the requested element ", messageNotSentException);

        return construirMensagemDeErro(
                messageNotSentException,
                messageNotSentException.getMessage(),
                HttpStatus.NOT_FOUND,
                request);
    }
